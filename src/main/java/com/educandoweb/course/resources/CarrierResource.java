...
import com.educandoweb.course.services.CarrierService;
...
public class CarrierResource {
	...
	public ResponseEntity<Carrier> findById(@PathVariable Long id){
		Carrier obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}
	
	@PostMapping
	public ResponseEntity<Carrier> insert(@RequestBody Carrier obj){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Carrier> update(@PathVariable Long id, @RequestBody Carrier obj){
