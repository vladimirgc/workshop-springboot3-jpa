...
import com.educandoweb.course.services.RevenueService;
...
public class RevenueResource {
	...
	@PostMapping
	public ResponseEntity<Revenue> insert(@RequestBody Revenue obj){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Revenue> update(@PathVariable Long id, @RequestBody Revenue obj){
